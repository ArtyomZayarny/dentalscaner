...
export type GetClinicsQuery = { __typename?: 'Query', clinics: Array<{ __typename?: 'Clinic', id: string, name: string, address: string, phone?: string | null, email?: string | null, description?: string | null }> };
...
export type GetAppointmentsQuery = { __typename?: 'Query', appointments: Array<{ __typename?: 'Appointment', id: string, userId: string, doctorId: string, clinicId: string, procedureId: string, date: string, time: string, duration: number, amount: number, status: AppointmentStatus, notes?: string | null, stripePaymentIntentId?: string | null, paid: boolean, createdAt: any, updatedAt: any }> };
...
export type GetAppointmentsByUserIdQuery = { __typename?: 'Query', appointmentsByUserId: Array<{ __typename?: 'Appointment', id: string, userId: string, doctorId: string, clinicId: string, procedureId: string, date: string, time: string, duration: number, amount: number, status: AppointmentStatus, notes?: string | null, stripePaymentIntentId?: string | null, paid: boolean, createdAt: any, updatedAt: any }> };
...
export type CreateAppointmentMutation = { __typename?: 'Mutation', createAppointment: { __typename?: 'Appointment', id: string, userId: string, doctorId: string, clinicId: string, procedureId: string, date: string, time: string, duration: number, amount: number, status: AppointmentStatus, paid: boolean, notes?: string | null, createdAt: any, updatedAt: any } };
...
export const CreateAppointmentDocument = gql`
    mutation CreateAppointment($userId: String!, $doctorId: String!, $clinicId: String!, $procedureId: String!, $date: String!, $time: String!, $duration: Int!, $amount: Float!, $notes: String) {
  createAppointment(
    userId: $userId
    doctorId: $doctorId
    clinicId: $clinicId
