...
function Topbar() {
  return (
    <>
      {/* Top Bar */}
      <header className=" bg-white flex items-center justify-between px-8 py-6  font-semibold text-lg w-full">
        {/* top panel */}
        {/* Search bar  */}
        ...
        <div className="flex gap-4">
          ...
          <div className="cursor-pointer relative w-10 h-10 flex items-center justify-center p-2">
            ...
            <BellIcon className="w-[23px] h-[27px] text-[#1A47C5]" />
          </div>

          {/* User icon */}
          <div>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-[url('/avatar.png')] " />
            </div>
          </div>
        </div>
      </header>
